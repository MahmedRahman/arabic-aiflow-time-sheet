...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-edit me-2"></i>تعديل المشروع: {{ $project->name }}</h2>
    <div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.projects.update', $project) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" 
                                ...
                                <option value="on_hold" {{ old('status', $project->status) == 'on_hold' ? 'selected' : '' }}>متوقف</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.projects.show', $project) }}" class="btn btn-secondary me-2">إلغاء</a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <strong>ملاحظة:</strong> تغيير سعر الساعة سيؤثر على سجلات الوقت الجديدة فقط.
                </div>
                ...
                <!-- إحصائيات سريعة -->
                <div class="mt-3">
                    <h6>إحصائيات المشروع:</h6>
                    <ul class="list-unstyled">
                        <li><strong>عدد سجلات الوقت:</strong> {{ $project->timeEntries->count() }}</li>
                        <li><strong>إجمالي الساعات:</strong> {{ number_format($project->timeEntries->sum('hours_worked'), 2) }}</li>
                        <li><strong>إجمالي المبلغ:</strong> {{ number_format($project->timeEntries->sum('total_amount'), 2) }} ج.م</li>
                    </ul>
                </div>
            </div>
        </div>
