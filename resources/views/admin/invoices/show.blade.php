...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        @if($invoice->status === 'draft')
            <form method="POST" action="{{ route('admin.invoices.send', $invoice) }}" class="d-inline">
                ...
                <button type="submit" class="btn btn-success me-2" 
                    ...
                    <i class="fas fa-paper-plane me-2"></i>إرسال للعميل
                </button>
            </form>
        @endif
        ...
        <a href="{{ route('admin.invoices.edit', $invoice) }}" class="btn btn-warning me-2">
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">إحصائيات الفاتورة</h5>
            </div>
            <div class="card-body">
